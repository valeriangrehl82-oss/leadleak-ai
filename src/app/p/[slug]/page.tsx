        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <aside className="animate-fade-slide animate-delay-1 space-y-5">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-[0_14px_40px_rgba(7,17,31,0.07)]">
              <p className="text-sm font-semibold uppercase tracking-wide text-swiss-green">Hinweis</p>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Bitte senden Sie keine medizinischen oder besonders schützenswerten Angaben über dieses Formular.
                Beschreiben Sie nur, was für die Rückmeldung nötig ist.
              </p>
            </div>
          </aside>
        </div>
